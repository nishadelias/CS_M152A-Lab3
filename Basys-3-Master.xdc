...
## Switches
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports {sel_switch}]
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports {adj_switch}]
...
#set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports rst_button]
...
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports rst_button]
